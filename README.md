...
当前仓库是从更早的小红书 skills 项目延续整理并持续改进的版本，早期仓库地址为 `autoclaw-cc/xiaohongshu-skills`。
...
**方法一：从 GitHub Releases 下载 ZIP（推荐）**

1. 打开 GitHub Releases 页面，下载最新的 `xiaohongshu-skills-<version>.zip`，并解压到你的 Agent skills 目录：
